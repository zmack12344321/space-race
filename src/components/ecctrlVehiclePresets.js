...
export const ECCTRL_VEHICLE_PRESETS = {
  sedanSports: { type: "car", wheelOffset: { x: 0.9, y: 0, z: 1.8 } },
  raceFuture: { type: "car", wheelOffset: { x: 0.85, y: 0, z: 1.5 } },
  taxi: { type: "car", wheelOffset: { x: 0.85, y: 0, z: 1.5 } },
  ambulance: { type: "car", wheelOffset: { x: 0.9, y: 0, z: 1.8 } },
  police: { type: "car", wheelOffset: { x: 0.9, y: 0, z: 1.8 } },
  truck: { type: "car", wheelOffset: { x: 0.85, y: 0, z: 1.5 } },
  firetruck: { type: "car", wheelOffset: { x: 0.9, y: 0, z: 1.8 } },
  goKart: { type: "car", wheelOffset: { x: 0.85, y: 0, z: 1.5 } },
