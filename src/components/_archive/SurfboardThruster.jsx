...
// Standalone hover thruster tuned for the SURFBOARD. Fully independent
// of <HoverThruster> — editing this file's logic never touches the UFO /
// go-kart thrusters. Every prop below (color, coreColor, scale, intensity,
// beamTop, beamBottom, beamHeight, rungs, flowSpeed,
// hueCycle, hueSat, hueLight, sparks, glow, fire) is exposed + editable
// in Triplex via its default values (Triplex infers controls from defaults).
