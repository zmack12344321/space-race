...
export function useLunarMaterial() {
  ...
  const material = useMemo(() => {
    ...
    // Provide dummy maps to force THREE to compile the map/normal chunks
    mat.map = diffA;
    mat.normalMap = norA;
    mat.normalScale = new THREE.Vector2(3.5, 3.5);

    mat.onBeforeCompile = (shader) => {
      shader.uniforms.diffA = { value: diffA };
      shader.uniforms.diffB = { value: diffB };
      shader.uniforms.norA = { value: norA };
      shader.uniforms.norB = { value: norB };
